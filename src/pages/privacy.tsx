          ...
          <div className="space-y-8 text-white/80 text-base leading-relaxed">
            ...
            <section>
              ...
              <ul className="space-y-2 list-disc list-inside text-white/70">
                ...
                <li>
                  <span className="text-white">학생이 보낸 리액션(이해 완료/속도 조절/재설명) 및 익명 질문</span>
                  — 작성자 식별 정보 없이 강의 회차에 누적되어 저장됩니다.
                </li>
                <li>
            ...
            <section>
              ...
              <ul className="space-y-2 list-disc list-inside text-white/70">
                ...
                <li>리액션·익명 질문·강의 회차: 강의 생성일로부터 최대 1년</li>
                <li>강의 자체(코드, 이름): 최대 1년 후 자동 삭제</li>
                <li>교수자가 강의를 직접 삭제하면 해당 강의의 모든 데이터가 즉시 제거됨</li>
              </ul>
            </section>
